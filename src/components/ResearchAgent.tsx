...
export function ResearchAgent() {
  ...
  return (
    <div className="min-h-screen bg-bg-main text-text-primary selection:bg-brand-primary/20 transition-colors duration-300">
      {/* Top Navigation */}
      <nav className="fixed top-0 left-0 right-0 h-16 border-b border-border-subtle bg-bg-nav backdrop-blur-md z-50 flex items-center justify-between px-6 sm:px-8 md:px-10 lg:px-16 xl:px-24 transition-colors duration-300 safe-top safe-x">
